    ...
    <>
      <div className="space-y-6 animate-in fade-in duration-500">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h1 className="text-2xl font-bold tracking-tight">Reinsurance Allocation</h1>
            <p className="text-sm text-slate-500 mt-1">Review treaty allocations, surplus distributions, and manage facultative placements.</p>
          </div>
